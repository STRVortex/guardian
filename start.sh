...
if [ -z "$PORT" ]; then
  echo "ᴘᴏʀᴛ ɪꜱ ɴᴏᴛ ꜱᴇᴛ. ᴠᴏʀᴛᴇx ɪꜱ ᴅᴇꜰᴀᴜʟᴛɪɴɢ ᴛᴏ 8080 🌐"
  PORT=8080
fi

if [ -z "$FLASK_APP" ]; then
  echo "ꜰʟᴀꜱᴋ ᴀᴘᴘ ɪꜱ ɴᴏᴛ ꜱᴇᴛ. ᴠᴏʀᴛᴇx ɪꜱ ᴅɪʀᴇᴄᴛʟʏ ʙᴏᴏᴛɪɴɢ ᴛᴏ ɪᴛꜱ ꜱᴇʀᴠᴇʀ ꜰʟᴀꜱᴋ ⚡"
...
echo "ꜱᴛᴀʀᴛɪɴɢ ʏᴏᴜʀ ꜱᴛᴏʀᴍ ʙᴏᴛ [ʙʏ ᴠᴏʀᴛᴇx] ⚡"
python3 -m src >> main.log 2>&1 &
